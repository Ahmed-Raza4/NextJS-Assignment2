...
export default function Home() {
  return (
    <div>
      <Header/>
      <div className="h-[50vh] w-[100vw] border-2 border-red-400 rounded-[10px] bg-yellow-100 text-[48px] flex items-center justify-center font-serif font-bold drop-shadow-2xl outline outline-stone-600 ">
      ...
      <div className="h-[40vh] w-[30vw] m-[20px] pl-[150px]">
        <Image src={pic} alt="Mypic" width={200} height={250} className="rounded-[10px]"/>
      </div>
      </div>
      <Footer/>
    </div>
